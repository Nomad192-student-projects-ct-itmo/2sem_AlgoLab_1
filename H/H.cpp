...
private:
    ...
    void down (size_t el)
    {
        ...
        switch (cur_node->assign.type) {
            ...
            {
                //printf("down set %zu\n", el);
                left_node->VALUE = SET(left_node->VALUE, cur_node->assign.val * (left_node->right - left_node->left));
                right_node->VALUE = SET(right_node->VALUE, cur_node->assign.val * (right_node->right - right_node->left));
                left_node->assign = cur_node->assign;
            ...
            {
                //printf("down add %zu\n", el);
                left_node->VALUE = ADD(left_node->VALUE, cur_node->assign.val * (left_node->right - left_node->left));
                right_node->VALUE = ADD(right_node->VALUE, cur_node->assign.val * (right_node->right - right_node->left));
                left_node->assign.val = ADD(left_node->assign.val, cur_node->assign.val);
                right_node->assign.val = ADD(right_node->assign.val, cur_node->assign.val);

                if (left_node->assign.type == Type {SET})
                    left_node->assign.type =  Type {SET};
                else
                    left_node->assign.type =  Type {ADD};
